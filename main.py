...
channel_id = '' # ID DE UM CANAL QUE A MAIORIA DAS PESSOAS VER COMO #regras etc
    ...
    for memberID in bot.gateway.session.guild(guild_id).members:
        ...
        if temp != None:
            ...
            if len(z) != 0:
                ...
                file.write(f'ID: <@{id}> | Nome de usuário: {username} | Badges: {badges} | Data de criação: {creation_date}\n')
